          ...
          <tr>
            <td style="padding: 40px;">
              ...
              <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.8;">
                مرحبًا بك في منصة كلمة! تم التسجيل بنجاح بصفتك <strong>${data.role}</strong> باستخدام حساب <strong>${displayProvider}</strong>.
              </p>
              
              <p style="margin: 0 0 20px; color: #4b5563; font-size: 16px; line-height: 1.8;">
                نظرًا لأنك استخدمت ${displayProvider} فإن بريدك مُصدق تلقائيًا، ولديك وصول كامل إلى جميع الميزات فورًا. إليك ما يمكنك فعله بعد ذلك:
              </p>
...
تم التسجيل بنجاح بصفتك ${data.role} باستخدام حساب ${displayProvider}.

نظرًا لأنك استخدمت ${displayProvider} فإن بريدك الإلكتروني مُصدق تلقائيًا، ولديك وصول كامل إلى جميع الميزات فورًا. إليك ما يمكنك فعله بعد ذلك:
