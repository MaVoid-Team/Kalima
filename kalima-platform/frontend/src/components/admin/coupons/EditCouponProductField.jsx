...
export default function EditCouponProductField({
    form,
    t,
    pickerOpen,
    setPickerOpen,
        ...
        <FormField
            ...
            render={({ field }) => (
                <FormItem>
                    ...
                    <div className="flex gap-2 flex-col sm:flex-row" data-testid="coupons-edit-product-picker">
                        <FormControl>
                            <Input
                                {...field}
                                ...
                                data-testid="coupons-edit-product-id-input"
                            />
                        </FormControl>
                    ...
                    {!!selectedProduct && (
                        <div className="rounded-md border bg-muted/30 p-3 text-sm space-y-1" data-testid="coupons-edit-selected-product-prices">
