    ...
    return (
        <div className="flex items-start gap-4">
            <div className="relative shrink-0">
                ...
                <span className="absolute -top-2 -right-2 w-5 h-5 bg-muted-foreground text-primary-foreground rounded-full text-xs font-semibold flex items-center justify-center">
                    {item.quantity}
                </span>
            </div>
