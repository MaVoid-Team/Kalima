        ...
        <div className="flex flex-col gap-4">
            <div className="space-y-4">
                ...
                {pricing.walletCredit > 0 && (
                    <div className="flex justify-between text-sm">
                        <span className="text-emerald-700 dark:text-emerald-400 font-medium">{t('orderSummary.walletCredit', { defaultValue: 'رصيد المحفظة المطبق' })}</span>
                        <span className="font-bold text-emerald-700 dark:text-emerald-400">-{pricing.walletCredit} <span className="text-[10px] uppercase">{t("cart:L.E")}</span></span>
                    </div>
                )}
            </div>

            <div className="flex justify-between items-end pt-6 border-t border-border/10 mb-2">
            ...
            <OrderReviewWarning className="mb-2" />
