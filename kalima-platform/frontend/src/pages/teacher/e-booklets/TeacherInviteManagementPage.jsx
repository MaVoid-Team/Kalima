    ...
    <div className="space-y-6" data-testid="teacher-invite-management-page">
      <div>
        ...
        <div className="mt-3 flex flex-wrap gap-2 text-sm">
          ...
          <Badge variant="outline"><CalendarClock className="h-3.5 w-3.5" />{t("teacher.invites.instanceExpiry", { value: formatDate(instanceExpiry) })}</Badge>
          <Badge variant="outline"><WalletCards className="h-3.5 w-3.5" />{t("teacher.wallet.balance", { value: formatMoney(wallet?.balance) })}</Badge>
        </div>
      </div>
