...
const vec3 LINE_COLOR = vec3(1.0, 0.0, 0.0); // Red
precision highp float;
...
void mainImage(out vec4 fragColor, in vec2 fragCoord) {
  ...
  // Calculate alpha based on brightness/length of the color
  // This allows the lines to be drawn over any background (light or dark)
  // smoothstep ensures standard visibility while fading out at very low intensities
...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    if (interactive) {
      containerRef.current.addEventListener("pointermove", handlePointerMove); // Listen on container
